    ...
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2 text-white'>
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            as='span'
            className='flex cursor-pointer items-center border-solid py-1 hover:text-white/70'
            renderPopover={
              <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                <div className='flex flex-col py-2 pl-1 pr-28'>
          ...
          {!isAuthenticated && (
            <div className='flex items-center'>
              ...
              <div className='h-4 border-r-[1px] border-r-white/60' />
        ...
        <div className='grid grid-cols-12 items-end gap-4'>
          ...
          <div className='col-span-1 mb-2 justify-self-center'>
            <Popover
              placement='bottom-end'
              renderPopover={
                <div className='relat<ive max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  {purchaseInCart ? (
                    <div className='p-2'>
